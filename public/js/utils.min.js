!(function () {
    ...
    function d(d, $) {
        ...
        for (; d.length && (n = d.shift()); )
            d.length || void 0 === $
                ? (e =
                      e[n] && e[n] !== Object.prototype[n] ? e[n] : (e[n] = {}))
                : (e[n] = $);
    }
    function $(d, $) {
        function n() {}
    ...
    (h.prototype.has = function (d) {
        ...
        (h.prototype.clone = function () {
            ...
            return (
                d != this &&
                    ...
                    d.c && (d.c = {}),
                    (function d($, n) {
                        for (var e = C($.f()), t = 0; t < e.length; t++) {
                            var r = e[t],
                                u = r.a;
                            if (null != n.a[u]) {
                                $.c && delete $.c[r.a];
        ...
        (N.prototype.c = function (d, $) {
            ...
            if (14 == d.c)
                return "string" == typeof $ && E.test($) && 0 < (d = Number($))
                    ? d
                    : $;
            if (!d.l) return $;
            if ((d = d.m) === String) {
    ...
    $(I, N),
        ...
        (G.prototype.c = function (d, $) {
            return 8 == d.c ? !!$ : N.prototype.c.apply(this, arguments);
        }),
        (G.prototype.a = function (d, $) {
            return G.o.a.call(this, d, $);
        }),
        (_.prototype.c = ""),
        (_.prototype.set = function (d) {
            this.c = "" + d;
        }),
        (_.prototype.a = function (d, $, n) {
    ...
    var H = {
        ...
        z = /(\$\d)/;
    function q(d) {
        return !(d.length < 2) && Md(j, d);
    }
    function dd(d) {
        return Md(Q, d) ? ed(d, Z) : ed(d, H);
    }
    function $d(d) {
        var $ = dd(d.toString());
        (d.c = ""), d.a($);
    ...
    function nd(d) {
        return null != d && (1 != M(d, 9) || -1 != m(d, 9)[0]);
    }
    function ed(d, $) {
        for (var n, e = new _(), t = d.length, r = 0; r < t; ++r)
    ...
    function rd(d, $, n) {
        ...
        e = b($, 1);
        var t = id($);
        if (0 == n) return fd(e, 0, t, "");
        if (!(e in x)) return t;
        (d = ud(d, e, pd(e))),
            ($ =
                null != $.a[3] && 0 != S($, 3).length
                    ? 3 == n
                        ? ";ext=" + S($, 3)
                        : null != d.a[13]
                        ? S(d, 13) + b($, 3)
        ...
        d: {
            for (
                var r,
                    u = (d =
                        0 == m(d, 20).length || 2 == n ? m(d, 19) : m(d, 20))
                        .length,
                    i = 0;
                i < u;
                ++i
                ...
                var f = M((r = d[i]), 3);
                if (
                    (0 == f || 0 == t.search(S(r, 3, f - 1))) &&
                    Md((f = new RegExp(S(r, 1))), t)
                ) {
                    d = r;
                    break d;
                }
        ...
        return (
            null != d &&
                ...
                (u = b(u, 4)),
                (t =
                    2 == n && null != u && 0 < u.length
                        ? t.replace(r, d.replace(z, u))
                        : t.replace(r, d)),
                3 == n &&
                    (t = (t = t.replace(
                        /^[-x\u2010-\u2015\u2212\u30fc\uff0d-\uff0f \u00a0\u00ad\u200b\u2060\u3000()\uff08\uff09\uff3b\uff3d.\[\]/~\u2053\u223c\uff5e]+/,
    ...
    function id(d) {
        ...
        var $ = "" + S(d, 2);
        return null != d.a[4] && S(d, 4) && 0 < b(d, 8)
            ? Array(b(d, 8) + 1).join("0") + $
            : $;
    }
    function fd(d, $, n, e) {
        switch ($) {
    ...
    function ld(d, $) {
        ...
        if (null == n) {
            ...
            (n = new G().a(O.f(), n)), (d.a[$] = n);
        }
        return n;
    }
    function cd(d, $) {
        var n = d.length;
        return !(0 < M($, 9) && -1 == u(m($, 9), n)) && Md(b($, 2), d);
    }
    function sd(d, $) {
        if (null == $) return null;
        var n = b($, 1);
        if (null == (n = x[n])) d = null;
    ...
    function Cd(d, $, n, e) {
        var t = 0 == M((r = ad(n, e)), 9) ? m(S(n, 1), 9) : m(r, 9),
            r = m(r, 10);
        if (2 == e) {
            if (!nd(ad(n, 0))) return Cd(d, $, n, 1);
            nd((d = ad(n, 1))) &&
                (i((t = t.concat(0 == M(d, 9) ? m(S(n, 1), 9) : m(d, 9)))),
    ...
    function hd(d, $) {
        var n = id($);
        return ($ = b($, 1)) in x ? Cd(d, n, ($ = ud(d, $, pd($))), -1) : 1;
    }
    function gd(d, $, n, e, t, r) {
        ...
        if (
            ((i =
                0 == f.length
                    ? 20
                    : w.test(f)
                    ? ((f = f.replace(w, "")), ($.c = ""), $.a(dd(f)), 1)
                    : ((f = new RegExp(i)),
                      $d($),
                      (i =
                          0 == (i = $.toString()).search(f) &&
                          ((f = i.match(f)[0].length),
                          !(
                              (u = i.substring(f).match(W)) &&
                              null != u[1] &&
                              0 < u[1].length &&
                              "0" == ed(u[1], H)
                          ) && (($.c = ""), $.a(i.substring(f)), !0)))
            ...
            return null != n &&
                ((f = "" + (i = b(n, 10))),
                0 == (u = $.toString()).lastIndexOf(f, 0) &&
                    ((f = new _(u.substring(f.length))),
                    (u = S(n, 1)),
                    (u = new RegExp(b(u, 2))),
                    Sd(f, n, null),
                    (f = f.toString()),
                    (!Md(u, $.toString()) && Md(u, f)) ||
                        3 == Cd(d, $.toString(), n, -1)))
                ? (e.a(f), t && T(r, 6, 10), T(r, 1, i), i)
                : (T(r, 1, 0), 0);
        if ($.c.length <= 2) throw Error("Phone number too short after IDD");
        d: {
            if (0 != (d = $.toString()).length && "0" != d.charAt(0))
                for (t = d.length, $ = 1; $ <= 3 && $ <= t; ++$)
                    if ((n = parseInt(d.substring(0, $), 10)) in x) {
                        e.a(d.substring($)), (e = n);
                        break d;
                    }
            e = 0;
        }
        if (0 != e) return T(r, 1, e), e;
    ...
    function Sd(d, $, n) {
        ...
        0 == i ||
            null == f ||
            0 == f.length ||
            ((i = (e = new RegExp("^(?:" + f + ")")).exec(u)) &&
                ((t = Md((f = new RegExp(b(S($, 1), 2))), u)),
                (r = i.length - 1),
                null == ($ = S($, 16)) ||
                0 == $.length ||
                null == i[r] ||
                0 == i[r].length
                    ? (t && !Md(f, u.substring(i[0].length))) ||
                      (null != n && 0 < r && null != i[r] && n.a(i[1]),
                      d.set(u.substring(i[0].length)))
                    : ((u = u.replace(e, $)),
                      (t && !Md(f, u)) ||
                          (null != n && 0 < r && n.a(i[1]), d.set(u)))));
    }
    function bd(d, $, n) {
        if (!td(n) && 0 < $.length && "+" != $.charAt(0))
            throw Error("Invalid country calling code");
        return md(d, $, n, !0);
    }
    function md($, n, d, e) {
                ...
                ? ((t = a + 15),
                  "+" == n.charAt(t) &&
                      (0 < (r = n.indexOf(";", t))
                          ...
                          : f.a(n.substring(t))),
                  (t = n.indexOf("tel:")),
                  f.a(n.substring(0 <= t ? t + 4 : 0, a)))
                : f.a(
                      (0 <= (i = (u = n).search(Y))
                          ? 0 <=
                                (i = (u = (u = u.substring(i)).replace(
                                    X,
                                    ""
                                )).search(J)) && (u = u.substring(0, i))
                          : (u = ""),
                      u)
                  ),
            0 < (t = (a = f.toString()).indexOf(";isub=")) &&
                ((f.c = ""), f.a(a.substring(0, t))),
            !q(f.toString()))
        )
            throw Error(
                "The string supplied did not seem to be a phone number"
        ...
        if (
            ((a = f.toString()),
            !(td(d) || (null != a && 0 < a.length && w.test(a))))
        )
            throw Error("Invalid country calling code");
        (a = new K()), e && T(a, 5, n);
        d: {
            if (0 <= (t = (n = f.toString()).search(k)) && q(n.substring(0, t)))
                for (var o = (r = n.match(k)).length, l = 1; l < o; ++l)
                    if (null != r[l] && 0 < r[l].length) {
                        (f.c = ""), f.a(n.substring(0, t)), (n = r[l]);
                        break d;
                    }
            n = "";
        }
        ...
        try {
            ...
            if ("Invalid country calling code" != d.message || !w.test(o))
                throw d;
            if (0 == (r = gd($, (o = o.replace(w, "")), t, n, e, a))) throw d;
        }
        if (
            (0 != r
                ? (f = pd(r)) != d && (t = ud($, r, f))
                : ($d(f),
                  ...
                  null != d
                      ? T(a, 1, (r = b(t, 10)))
                      : e && (delete a.a[6], a.c && delete a.c[6])),
            n.c.length < 2)
        )
            throw Error(
        ...
        if (
            (null != t &&
                ((d = new _()),
                Sd((f = new _(n.toString())), t, d),
                2 != ($ = Cd($, f.toString(), t, -1)) &&
                    4 != $ &&
                    5 != $ &&
                    ((n = f),
                    e && 0 < d.toString().length && T(a, 7, d.toString()))),
        ...
        if (1 < e.length && "0" == e.charAt(0)) {
            for (T(a, 4, !0), $ = 1; $ < e.length - 1 && "0" == e.charAt($); )
                $++;
            1 != $ && T(a, 8, $);
        }
        return T(a, 2, parseInt(e, 10)), a;
    }
    function Md(d, $) {
        return !(
            !(d =
        ...
        d("intlTelInputUtils.formatNumber", function ($, d, n) {
            try {
                var e = V.a(),
                    t = bd(e, $, d),
                    r = hd(e, t);
                return 0 == r || 4 == r ? rd(e, t, void 0 === n ? 0 : n) : $;
            } catch (d) {
                return $;
            }
        }),
        ...
        d("intlTelInputUtils.isValidNumber", function (d, $) {
            try {
                ...
                if (!(n = null == i)) {
                    if ((a = "001" != r)) {
                        var f = ld(e, r);
                        if (null == f) throw Error("Invalid region code: " + r);
                        var a = u != b(f, 10);
                    }
                    n = a;
                }
                return !n && -1 != od(id(t), i);
            } catch (d) {
                return !1;
            }
        }),
