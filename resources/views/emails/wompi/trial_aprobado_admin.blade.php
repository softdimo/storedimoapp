...
<html lang="es">
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>✅ Nueva Suscripción TRIAL Aprobada</h1>
            </div>
            <div class="body">
                <p>Se ha registrado una nueva suscripción con Plan Trial.</p>
                ...
                <p style="margin-top: 20px; font-size: 13px; color: #666;">
                    Recuerda activar el acceso del cliente en el panel de administración.
                </p>
            </div>
            <div class="footer">
