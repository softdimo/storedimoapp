...
@section('scripts')
    ...
    $("#precio_detal").on({
        ...
        "keyup": function (event) {
            $(event.target).val(function (index, value) {
                ...
                // Quitar todos los puntos (miles) para procesar
    ...
    $(document).ready(function()
    {
        ...
        // Valido que el precio unitario sea menor que el precio al detalg 
        $('#precio_detal').blur(function()
        {
            let precioUnitario = $('#precio_unitario').val() || 0;
            let precioDetal = $('#precio_detal').val() || 0;
        ...
        $('#precio_por_mayor').blur(function()
        {
            let precioUnitario = $('#precio_unitario').val() || 0;
            let precioDetal = $('#precio_detal').val() || 0;
            let precioPorMayor = $('#precio_por_mayor').val() || 0;
